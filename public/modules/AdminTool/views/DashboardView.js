        ...
        var DashboardView = Backbone.Marionette.Layout.extend({
            ...
            drawUsers: function (data) {
                if ($('#User').length === 0) {
                    ...
                    $("#User").append("<tr><td align='middle'>Name</td> | <td align='middle'>Email</td><td align='middle'>Status</td></tr><br>");
